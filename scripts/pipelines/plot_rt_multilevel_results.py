...
LASSO_CLUSTER_CSV = {
    ...
    "lasso_eslasso_local": "rt_eval_lasso_local_by_species_cluster_realtest.csv",
}

LASSO_SUPPORT_CSV = {
    "lasso_eslasso_species_cluster": "rt_eval_lasso_by_support_realtest.csv",
    "lasso_eslasso_local": "rt_eval_lasso_local_by_support_realtest.csv",
}

LASSO_GLOBAL_JSON = {
    "lasso_eslasso_species_cluster": "rt_eval_lasso_realtest.json",
    "lasso_eslasso_local": "rt_eval_lasso_local_realtest.json",
}
...
def _plot_per_lib_cluster_panels(
    *,
    ...
    color_map = {
        ...
        "lasso_eslasso_local": "tab:purple",
    }

...
This is a lightweight companion to `scripts/pipelines/eval_rt_lasso_baseline.py` that focuses on
per-species-cluster breakdown for quick comparisons against other RT models.

...
\texttt{sally-dev evaluate} (script: \path{external_repos/sally/scripts/sally-dev}; baseline \texttt{ESLASSO} vs candidate
...
8 & 20159 & COMPASSIGN\_PP\_RIDGE (partial pooling ridge) & \textbf{0.8951} & \textbf{0.8766} & \textbf{0.7950} \\
\midrule
6 & 23059 & ESLASSO (supercategory lasso) & 0.8357 & 0.5940 & 0.5319 \\
6 & 23059 & COMPASSIGN\_PP\_RIDGE (partial pooling ridge) & \textbf{0.8388} & \textbf{0.6598} & \textbf{0.5855} \\
\bottomrule
\end{tabular}
\end{table}
...
For lib209, \texttt{COMPASSIGN\_PP\_RIDGE} improves TS by approximately +0.01 (SSID 20159) and +0.05 (SSID 23059).
...
\texttt{COMPASSIGN\_PP\_RIDGE} improves Threat Score (TS) versus the current \texttt{ESLASSO} baseline on all checks (lib208:
approximately +0.10, +0.06, +0.12; lib209: approximately +0.01, +0.05). This indicates the RT gains translate into

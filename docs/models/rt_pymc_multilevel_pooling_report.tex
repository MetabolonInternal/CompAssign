...
6 & 12307 & COMPASSIGN\_PP\_RIDGE (partial pooling ridge) & \textbf{0.9496} & \textbf{0.8033} & \textbf{0.7704} \\
\midrule
8 & 12609 & ESLASSO (supercategory lasso) & \textbf{0.8553} & 0.6513 & 0.5867 \\
8 & 12609 & COMPASSIGN\_PP\_RIDGE (partial pooling ridge) & 0.8483 & \textbf{0.7203} & \textbf{0.6381} \\
\midrule
6 & 12725 & ESLASSO (supercategory lasso) & 0.6808 & \textbf{0.8610} & 0.6134 \\
6 & 12725 & COMPASSIGN\_PP\_RIDGE (partial pooling ridge) & \textbf{0.8911} & 0.8098 & \textbf{0.7369} \\
\bottomrule
\end{tabular}
\end{table}
...
On these selected cell-type SSIDs, \nolinkurl{COMPASSIGN_PP_RIDGE} improves TS by approximately +0.09 (SSID 12307),
+0.05 (SSID 12609), and +0.12 (SSID 12725) versus \texttt{ESLASSO} for lib208.
For lib209, \nolinkurl{COMPASSIGN_PP_RIDGE} improves TS by approximately +0.01 (SSID 20159) and +0.05 (SSID 23059).
...
For these cap100-trained lib208/lib209 models, all compounds included in the exported coefficient summaries had
ChemBERTa embeddings available (0 missing chem embeddings), so the ``missing SMILES'' fallback path is not exercised in
the Sally runs reported here.
...
approximately +0.09, +0.05, +0.12; lib209: approximately +0.01, +0.05). This indicates the RT gains translate into

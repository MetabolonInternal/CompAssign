...
class PresencePrior:
    ...
    def init(cls, 
             ...
             empirical_counts: Optional[Dict[Tuple[int, int], int]] = None) -> "PresencePrior":
        """
    ...
    def update_null(self):
        ...
        assignments slightly more likely in the future.
        """
        self.alpha_null += 1
    
    def update_not_null(self):
        """
        Update prior after observing a non-null assignment.
        
        This increments the beta parameter for null, making null
        assignments slightly less likely in the future.
        """
        self.beta_null += 1
